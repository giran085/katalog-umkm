        ...
        <div className="min-h-screen bg-gray-50 pt-20 pb-8 flex flex-col overflow-x-hidden">
            <div className="container mx-auto px-4 w-full flex-grow flex flex-col items-center">
                ...
                <div className="text-center mb-8 md:mb-12">
                    ...
                    {/* Info hint */}
                    <div className="mt-4 inline-flex items-center gap-2 bg-pink-50 border border-pink-200 text-pink-700 text-xs md:text-sm px-4 py-2 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" />
                        </svg>
                        Klik gambar testimoni untuk melihat foto lengkap
                    </div>
                </div>
